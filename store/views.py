...
def home(request):
    ...
    return render(
        request, "home.html", {"products": products, "slides": slides, "amount": amount}
    )
...
@login_required(login_url="users:request_code")
...
def favorite_page(request):
    ...
    amount = show_amount(request)
    return render(
        request, "favorite.html", {"favorites": favorite_products, "amount": amount}
    )
