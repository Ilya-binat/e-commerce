    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Конкретные разрешения для пользователя.', related_name='custom_permission_set', to='auth.permission', verbose_name='права пользователя')),
            ],
            options={
                'verbose_name': 'user',
